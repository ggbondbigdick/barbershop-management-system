...
import { ElMessage, ElUpload, UploadRawFile, UploadRequestOptions, UploadUserFile, UploadFile, UploadProps } from 'element-plus'
 ...
 * 删除图片
 */
function handleRemove(removeFile: any) {

  const fileId = removeFile?.id
